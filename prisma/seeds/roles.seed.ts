...
const ROLES: SeedRole[] = [
  {
    ...
    permissions: [
      ...
      { action: "manage", resource: "finance_dashboard" },
      { action: "manage", resource: "finance_expenses" },
      { action: "manage", resource: "finance_invoices" },
      { action: "manage", resource: "finance_payroll" },
      { action: "manage", resource: "finance_accounts" },
      { action: "manage", resource: "finance_reports" },
    ],
  },
  {
    name: "admin",
  ...
  },
  {
    ...
    permissions: [
      ...
      // Finance — manager có quyền xem và quản lý tài chính cơ bản
      { action: "read", resource: "finance_dashboard" },
      { action: "create", resource: "finance_expenses" },
      { action: "read", resource: "finance_expenses" },
      { action: "update", resource: "finance_expenses" },
      { action: "approve", resource: "finance_expenses" },
      { action: "create", resource: "finance_invoices" },
      { action: "read", resource: "finance_invoices" },
      { action: "update", resource: "finance_invoices" },
      { action: "create", resource: "finance_payroll" },
      { action: "read", resource: "finance_payroll" },
      { action: "update", resource: "finance_payroll" },
      { action: "read", resource: "finance_reports" },
    ],
  },
  {
    name: "accountant",
    description: "Kế toán — toàn quyền tài chính, chỉ xem orders và nhân sự",
    isSystem: false,
    permissions: [
      { action: "read", resource: "orders" },
      { action: "read", resource: "order_items" },
  ...
  {
    name: "staff",
    description: "Nhân viên — xem orders và thực hiện công việc được giao",
    isSystem: true,
    permissions: [
      { action: "read", resource: "settings" },
      { action: "read", resource: "crm_customers" },
