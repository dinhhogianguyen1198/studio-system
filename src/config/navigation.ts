...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: Receipt,
    permission: { resource: "workforce_payroll", action: "read" },
    section: "Vận hành",
  },
  ...
  // ── Tài chính ─────────────────────────────────────────────────────────────────
  {
    ...
    icon: Wallet,
    permission: { resource: "finance_dashboard", action: "read" },
    section: "Tài chính",
  },
  {
    title: "Chi phí",
    ...
    icon: Receipt,
    permission: { resource: "finance_expenses", action: "read" },
    section: "Tài chính",
  },
  {
    title: "Hóa đơn",
    ...
    icon: FileText,
    permission: { resource: "finance_invoices", action: "read" },
    section: "Tài chính",
  },
  {
    title: "Thanh toán freelancer",
    href: "/dashboard/finance/payroll",
    icon: Wallet,
    permission: { resource: "finance_payroll", action: "read" },
    section: "Tài chính",
  },
  {
    ...
    icon: TrendingUp,
    permission: { resource: "finance_reports", action: "read" },
    section: "Tài chính",
  },
